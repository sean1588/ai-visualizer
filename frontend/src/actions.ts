...
export function buildDashboardActions(ctx: DashboardActionContext): DashboardAction[] {
  ...
  return [
    ...
    { id: 'analyze', elementId: 'open-workbench', group: 'view', label: 'Analyze', hint: 'Open Focus, Goals, Brief, Recipe, and Notes', visible: ready, enabled: ready, run: () => ctx.openWorkbench('focus') },

...
export function buildDashboardActions(ctx: DashboardActionContext): DashboardAction[] {
  ...
  return [
    ...
    { id: 'analyze', elementId: 'open-workbench', group: 'view', label: 'Analyze', hint: 'Open the analysis workbench', visible: ready, enabled: ready, run: () => ctx.openWorkbench('focus') },
